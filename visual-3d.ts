...
export class GdmLiveAudioVisuals3D extends LitElement {
  ...
  protected firstUpdated() {
    // Fix: Property 'renderRoot' does not exist on type 'GdmLiveAudioVisuals3D'.
    // Replaced with `this.shadowRoot` which is standard for accessing the shadow DOM in a LitElement.
